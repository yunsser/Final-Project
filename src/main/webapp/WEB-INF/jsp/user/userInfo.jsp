...
<!-- 본문 시작 -->
	<div id = "info" class = "container">
		<div id = "article">
			<form id = "updateForm" class="container" onsubmit = "return update()" enctype="multipart/form-data">
			  <fieldset>
				...
				<div class="form-row text-center">
					...
					<p />
					<div class="col-12">
						    <button type="button" class="btn btn-outline-danger" onclick ="return deleted()">회원탈퇴</button>
					</div>
				</div>
				<p />
			</form>
