...
<style>
   ...
   .rv_button { margin-top:10px; margin-left: 10px; }
   .reviewlist {
      margin-top : 15px;
   }
          ...
          <h2>Review</h2>
            ...
            <c:if test = "${user.user.uid != null}">
                <label for="rv_title" class="form-label mt-4" style="width: 5%">제 목</label>
                 <input type="text" class="form-control" placeholder="제목을 적어주세요." name="rv_title" id="rv_title" style="width:50%; display: inline-block;">
               <!-- <label for="rv_contents" class="form-label mt-4">내용</label> -->
               <textarea class="form-control" name="rv_contents" id="rv_contents" rows="3" placeholder="내용을 적어주세요."></textarea>
               <div class="rv_button">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingOne">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        <c:forEach begin="0" end="0" var="page" items="${pageInfo.list}" >
           <strong>${page.rv_title}</strong>&nbsp&nbsp
           <code>${page.rv_id }</code>
        </c:forEach>
      </button>
    </h2>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingTwo">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
        <c:forEach begin="1" end="1" var="page" items="${pageInfo.list}" >
           <strong>${page.rv_title}</strong>&nbsp&nbsp
           <code>${page.rv_id }</code>
        </c:forEach>
      </button>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingThree">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
        <c:forEach begin="2" end="2" var="page" items="${pageInfo.list}" >
           <strong>${page.rv_title}</strong>&nbsp&nbsp
           <code>${page.rv_id}</code>
        </c:forEach>
      </button>
  ...
  <div class="accordion-item">
    ...
    <h2 class="accordion-header" id="headingFour">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
        <c:forEach begin="3" end="3" var="page" items="${pageInfo.list}" >
           <strong>${page.rv_title}</strong>&nbsp&nbsp
           <code>${page.rv_id }</code>
        </c:forEach>
      </button>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingFive">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
        <c:forEach begin="4" end="4" var="page" items="${pageInfo.list}" >
           <strong>${page.rv_title}</strong>&nbsp&nbsp
           <code>${page.rv_id }</code>
        </c:forEach>
      </button>
...
<div>
  <ul class="pagination">
     <li class="page-item">
      ...
      <a class="page-link" href="/detail?mgtno=${mgtno}&pageNum=${pageInfo.navigateFirstPage-1}">&laquo;</a>
        </c:if>
    </li>
...
<c:choose>
    ...
    <li class="page-item active">
      <a class="page-link" href="/detail?mgtno=${mgtno}&pageNum=${num}">${num}</a>
    </li>
    </c:when>
    <c:otherwise>
    <li class="page-item">
     ...
     <li class="page-item">
      ...
      <a class="page-link" href="/detail?mgtno=${mgtno}&pageNum=${pageInfo.navigateLastPage+1}">&raquo;</a>
        </c:if>
    </li>
  </ul>
</div>
